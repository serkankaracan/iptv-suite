...
| Protected storage | Packaged create/read/update/delete + reset/uninstall/reinstall/repair; per-record bulk locator düzeni 50k Decision'da reddedildi, reviewed alternatifin 50k performansı açık | M4/M8 |
...
- Per-record DPAPI bulk channel-locator throughput'u ölçülüp 50k bütçesinde reddedildi; düşük-cardinality source credential kullanımı ile reviewed alternatifin exact envelope/database layout'u açık.
