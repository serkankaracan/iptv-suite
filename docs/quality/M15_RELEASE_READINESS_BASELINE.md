...
Exact DWM sampling hardening'inden sonra clean `1ce6c80b97c886a7a40a676359e8d22a3fc22a6d` için [Windows package SBOM producer run `#14` (`33057515129`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33057515129), job `98467896870` ile `2026-08-27T09:20:32Z` zamanında `success` tamamlandı. Artifact `9640487894`, `7.825` byte ve digest `efa26bbeaed2b47e6329e051334aea517629f781470ac32db4fd47e89f14a8c1`; application MSIX SHA-256 `1757f6560dcdb01cfa9bb8bd240e9ec4262616e9da86f7cb805a5729529a1cb1` ve SPDX SHA-256 `04c754223dfaece663c52fc01a9418e07fb41ee1e35949d49a282da364268777`dır. Acceptance ledger raw SHA-256 `a9f6212ba99c09068825da6f6bbf05fa65c58a410f7f1fa21d00b8ca1daf6e1b`; exact `115` dosyalık current package-producing snapshot `5568fb8fc87f614392762501cb2a4b3be1a13487bb8cfab037ccaec579756810` ve exact yedi-file contract `453707fe0440239737a7c66362a94bb5054873bbfd777c6db6e7a7104c60fd1d` ile fail-closed bağlıdır. Official ve strict SBOM validation birlikte `PASS`tir.

Bu ledger'a zincirlenen [known-vulnerability producer run `#65` (`33057496306`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33057496306), aynı clean `1ce6c80b97c886a7a40a676359e8d22a3fc22a6d` üzerinde job `98467829624` ve artifact `9640281201` ile `2026-08-27T09:14:09Z` zamanında `success` tamamlandı. Artifact `1.121` byte ve digest `bad809a71dfbb3c05655795bc3c05b251c3dfe53c5b67c1f1309bed36fdc2c3a`dır; exact `4/0/4` audited restore, 23-package graph ve direct/transitive/toplam `0/0/0` bilinen vulnerability sonucu official+strict validation'dan geçti. CVE acceptance ledger raw SHA-256 `ee7e95df83dadaaa4d6e352e4807c819b26c9be23db53dc3b36f11d84a771e1c`; yedi günlük teknik freshness sonu `2026-09-03T09:14:09Z`dir. Ayrı final-release freshness sınırı inclusive `2026-08-28T09:14:09Z`dir: bu anda schema-v7 local doğrulama `packageSbomAcceptance.result=accepted-current`, `technicalBaselinePassed=true`, `releaseReady=false` ve exact 12 external blocker üretir; bir saniye sonrasında `CveReviewPending` yeniden açılır ve blocker sayısı 13 olur. Ledger/schema/contract tahrifi, daha yakın package override ve iki geçiş arasındaki TOCTOU değişimi hard-invalid kalır; bu teknik yenileme M15 completion, hukuk/Store/signing ya da genel “CVE-free” iddiası değildir.
