...
Install-root watcher hardening'inden sonra clean `74c66af16b2b72c85496855aa174ed01f563cf38` için [Windows package SBOM producer run `#13` (`33042549429`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33042549429), job `98419190374` ile `2026-08-27T05:35:45Z` zamanında `success` tamamlandı. Artifact `9634554249`, `7.735` byte ve digest `4a5d330e9eb1fe9bc52a9b3acf02e7a5ec1f14c94295f8586dc7aa84f9dea4ef`; application MSIX SHA-256 `740793bd3f2f9a9737b790268f51ab38799d6d63f2da96811d031bb969979b81` ve SPDX SHA-256 `2b055414848e2f2ebaff663d7a1f7c313288c9c6d60ffa362487fdedce52ff44`dır. Acceptance ledger raw SHA-256 `84e5977428543ab52c80408bcb34fff72f5034acc34b6169c539c9511e422289`; exact `115` dosyalık current package-producing snapshot `5568fb8fc87f614392762501cb2a4b3be1a13487bb8cfab037ccaec579756810` ve exact yedi-file contract `a8aaa5810e4f26b9e42268f942a98d110aac78da850ab869bb1b884521a5f687` ile fail-closed bağlıdır. Official ve strict SBOM validation birlikte `PASS`tir.

Bu ledger'a zincirlenen [known-vulnerability producer run `#59` (`33043196165`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33043196165), clean `44506bfe50047ca8930417454488d2cafde7bbf3` üzerinde job `98421205106` ve artifact `9634659536` ile `2026-08-27T05:41:19Z` zamanında `success` tamamlandı. Artifact `1.122` byte ve digest `07ec9d4a93dc4ea53328ee5e1390bcb1c42b9763e86b4116ca2aec7bacd18cc1`dir; exact `4/0/4` audited restore, 23-package graph ve direct/transitive/toplam `0/0/0` bilinen vulnerability sonucu official+strict validation'dan geçti. CVE acceptance ledger raw SHA-256 `fbd0929b7ea4a8254352da0abe2ded7b1f9a7a0665a42ad64ce47c6b415900ee`; yedi günlük teknik freshness sonu `2026-09-03T05:41:19Z`dir. Ayrı final-release freshness sınırı inclusive `2026-08-28T05:41:19Z`dir: bu anda schema-v7 local doğrulama `packageSbomAcceptance.result=accepted-current`, `technicalBaselinePassed=true`, `releaseReady=false` ve exact 12 external blocker üretir; bir saniye sonrasında `CveReviewPending` yeniden açılır ve blocker sayısı 13 olur. Ledger/schema/contract tahrifi, daha yakın package override ve iki geçiş arasındaki TOCTOU değişimi hard-invalid kalır; bu teknik yenileme M15 completion, hukuk/Store/signing ya da genel “CVE-free” iddiası değildir.
