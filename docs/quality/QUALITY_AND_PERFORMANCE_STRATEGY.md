...
| M4 | IN PROGRESS: local fake + CurrentUser DPAPI foundation 135/135 iki-run PASS; typed initialization + exact stale-temp cleanup dahil; packaged lifecycle, wrong-user, source deletion/record reconciliation ve 50k karar pending |
