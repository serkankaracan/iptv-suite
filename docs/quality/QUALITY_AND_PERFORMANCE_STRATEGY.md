...
- Per-record DPAPI bulk-locator layout'ı bütçeyi karşılamadığı için envelope-encryption/encrypted-database adaylarının threat model'i ve karşılaştırmalı benchmark planı ayrıca yazılacak.
