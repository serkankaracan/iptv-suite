...
| M4 | IN PROGRESS: tarihsel protected-store v1 hosted foundation/source-draft/package initialization 153/153 iki-run PASS; owner-v2 öncesi internal source-payload decoder local snapshot'ı 159/159 x2 PASS; owner-bound `SRCSEC02`/`LocalCache\ProtectedStore\v2` local gate 171/171 x2 PASS, hosted/package evidence pending; update/reset/uninstall, wrong-user, authoritative owner metadata, tuple/origin policy, source deletion/record reconciliation ve 5k–50k Decision/ADR kararı açık |
