...
| M4 | IN PROGRESS: tarihsel protected-store v1 hosted foundation/source-draft/package initialization 153/153 iki-run PASS; internal decoder 159/159 ve owner-v2 171/171 local snapshot'ları PASS; packaged lifecycle harness dahil güncel local gate 172/172 x2 PASS; ayrı same-version/two-process lifecycle hosted evidence pending; gerçek update/reset/uninstall-reinstall, wrong-user, authoritative owner metadata, tuple/origin policy, source deletion/record reconciliation ve 5k–50k Decision/ADR kararı açık |
