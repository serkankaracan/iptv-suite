...
| M4 | IN PROGRESS: güncel local fake + CurrentUser DPAPI foundation, source-draft protection, fail-closed retained packaged composition ve 1.024 temp-aday cap'i 153/153 iki-run PASS; hosted `ProtectedStoreDirectoryInitialized` artifact'ı pending; packaged update/reset/uninstall, wrong-user, source deletion/record reconciliation ve 5k–50k Decision/ADR kararı açık |
