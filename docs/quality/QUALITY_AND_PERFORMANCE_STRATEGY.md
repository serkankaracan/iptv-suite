...
| M15 | `SUCCESSOR TECHNICAL CHAIN RENEWED / EXTERNAL RELEASE BLOCKERS OPEN, 2026-08-29`: clean `507e8f2c429759acf98d1a18477c994985ee357c` üzerindeki SBOM run `#19` (`33255219751`) ve exact accepted SBOM ledger'ına zincirlenen clean `cc8073b48a340aabb8e30b28fe427d89669402e0` üzerindeki CVE run `#98` (`33255965631`) official+strict current'tır. Final-release CVE freshness geçerliyken exact 12 external blocker açıktır; freshness sona ererse `CveReviewPending` ayrıca açılır. WACK/private Store, production identity/lifecycle, license/NOTICE/privacy/codec-IP hukuk/signing ve diğer kapılar açık; M15 tamamlanmış değildir. [Baseline](M15_RELEASE_READINESS_BASELINE.md) |
| M16 | `SUCCESSOR AUTOMATED ACCEPTANCE CURRENT / BLOCKED, 2026-08-29`: clean `4daf95c615981a3bed4970e71575791646a2ae7a` üzerindeki run `#338` (`33256589562`), iki deterministik `736/736` quality turu, exact `86/86` ArchitectureTests, sentetik journey, dört yüzeyli final-artifact ve aynı-run MSIX/SBOM bağlarını geçti; üç acceptance ledger'ı current'tır. `m16TechnicalGateSetPassed=false`, `candidateReady=false`; feature freeze, fiziksel cihaz/accessibility matrisi, release-operations kabulü ve 24 saat soak olmak üzere exact dört M16 blocker ile exact M15 blocker'ları korunur. [Baseline](M16_RELEASE_CANDIDATE_BASELINE.md) |
