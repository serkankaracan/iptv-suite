...
| M15 | `IN PROGRESS / BLOCKED, 2026-08-25`: clean `0236894f8cc8c6212305f5ba9c294e335f3d031e` schema-v1 static audit'te `technicalBaselinePassed=true`, `releaseReady=false`; exact 8 asset, 4 schema-v2 lockfile, 23 package adı ve tarihsel 16 blocker. Evidence `19.343` byte, SHA-256 `b41bad875b940958b52383051b215630fae22b8487ba3263f2237b78c9061895`; run #221 (`32873776770`) required zinciri PASS etti. Clean `5e60ca6bd60d72e35438a08b18f2d5fe4267f3e9` için run #223 attempt 2 (`32881949188`) exact install-root runtime audit'ini sıfır mutation ve pre/post equivalent `true` ile geçirdi; architecture `51/51`dir. Schema-v2 x64-only disposition `releaseArchitectures=[x64]`, ARM64 deferred ve `AppxBundle=Never` kararını version 1 source-controlled MSBuild import-surface denetimiyle fail-closed kilitler; `Arm64ReleaseDecisionPending` kapanır, local full gate `568/568 × 2` PASS ve `releaseReady=false` ile 15 blocker kalır. WACK/private Store, production identity/lifecycle, SBOM/license/CVE/privacy/legal ve diğer blocker'lar açık. [Baseline](M15_RELEASE_READINESS_BASELINE.md) |
