...
**Current milestone status — `HOSTED SBOM/CVE RENEWED / BLOCKED; 12 external M15 blocker açık, 2026-08-28`:** Güncel schema-v7 release-readiness validator'ı exact x64 mimari/import-surface, asset provenance, package inventory ve SBOM/CVE ledger sözleşmelerini doğrular. Clean `f6e8fdbb56644bff62ab261cb4725d1088e5124a` için [SBOM producer run `#15` (`33143245610`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33143245610), current `115` dosyalık package-producing snapshot'ı ve exact yedi-file contract'ı official+strict `PASS` package/SBOM artifact'ına bağladı. Farklı clean commit `1c7ae00298414fb7707ad6097e151fc39aa38c03` üzerindeki [known-vulnerability run `#88` (`33143833495`)](https://github.com/serkankaracan/iptv-suite/actions/runs/33143833495), bu exact accepted SBOM ledger hash'ine zincirlenerek exact `4/0/4` audited restore ve `2 + 21 = 23` package graph için `0/0/0` bilinen vulnerability sonucu üretti. Yedi günlük teknik freshness `2026-09-04T05:09:29Z` zamanına kadar sürer; ayrı final-release freshness sınırı inclusive `2026-08-29T05:09:29Z`dir. Bu final-release sınırında local sonuç `packageSbomAcceptance.result=accepted-current`, `technicalBaselinePassed=true`, `releaseReady=false` ve exact 12 external M15 blocker'dır; bir saniye sonrasında `CveReviewPending` yeniden açılır ve blocker sayısı 13 olur. Ledger/schema/contract tahrifi, daha yakın package override ve iki geçiş arasındaki TOCTOU değişimi hard-invalid kalır. Bu teknik yenileme M15 completion, private-flight/WACK/Store, hukuk/signing veya genel “CVE-free” iddiası değildir. [Teknik baseline ve exact blocker seti](../quality/M15_RELEASE_READINESS_BASELINE.md).
...
**Current milestone status — `M15 TECHNICAL CHAIN RENEWED / M16 AUTOMATED ACCEPTANCE LEDGERS CURRENT / BLOCKED; 4 M16 blocker açık, 2026-08-28`:** Schema-v1 RC aggregator, sabit ve bounded predecessor evidence girdilerini fail-closed doğrulayıp sanitized `result=blocked`, `m16TechnicalGateSetPassed=false` ve `candidateReady=false` özeti üretir; schema v1 yapısal olarak release-ready sonuç veremez. Final-artifact ve security/architecture kabulleri clean `c5db51438b3fd9247c92fa2946b13ad09147f9cc` üzerindeki run `#327` (`33145434224`) ile sırasıyla exact `39` ve `330` source closure'larında yenilendi; iki deterministik `634/634` quality turu, signed MSIX lifecycle, DPAPI ve required gate tamamen yeşildir. Synthetic journey ayrı run `#321` (`33127559624`) ve exact `132`-source closure'ında current kalır. Automated M16 ledger kapıları kapalıdır; feature freeze ile release-operations kabulü iki recorded-decision; fiziksel cihaz/accessibility matrisi ile 24 saat soak iki operator-evidence olmak üzere dört M16 blocker ile exact M15 blocker'ları korunur. Raw ledger/schema/artifact tutarsızlığı hard-invalid kalır; TLS pinning, timeout ve bütün assertion'lar aynıdır. Bu checkpoint M15/M16 completion, private-flight/WACK/Store, hukuk/signing, penetration/SAST, fiziksel cihaz, feature-freeze veya uzun-soak kabulü değildir. [Blocked baseline ve non-claim'ler](../quality/M16_RELEASE_CANDIDATE_BASELINE.md).
