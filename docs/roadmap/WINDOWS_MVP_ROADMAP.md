...
**Güncel SBOM/CVE kabul yenilemesi — `HOSTED VERIFIED, 2026-08-26`:** DWM refresh-counter gap normalizasyonu ve exact single-refresh maximum korumasından sonra bağımsız [SBOM producer run `#1` (`32918708589`)](https://github.com/serkankaracan/iptv-suite/actions/runs/32918708589), clean `e7564aa9382fb12b10869866811e75847d1f6f16` üzerinde signed package/SBOM zincirini geçti. SBOM acceptance ledger SHA-256 `9eaf890f027f3485e89851701cfbfe4676afb44be4a918f525290c58385d9a21`; dedicated workflow dahil exact yedi-file contract SHA-256 `e5324fafa743cd003af480ab2c521ae2181a306fd67704c221d905025a7fccae`dir. Buna exact ledger hash'iyle zincirlenen [CVE producer run `#10` (`32919649968`)](https://github.com/serkankaracan/iptv-suite/actions/runs/32919649968), commit `15826e5ecad4a4b5737aa7bf39d28c62b0e71de7` üzerinde `4/0/4` audited restore ve `0/0/0` bilinen vulnerability sonucunu yeniden geçti. Güncel CVE ledger SHA-256 `01180e5c90816fda2f1712a2ecd5ed634399caee76d68b7ffeb47c178e2aa208`; freshness sonu `2026-09-02T01:38:42Z`dir. Önceki `#226` ve `#4` kayıtları ilk kabul tarihçesidir; güncel kabul bu iki renewal run'ıdır. Threshold, blocker ve hukuk kapsamı değişmedi.

**Deterministic package asset provenance — `IMPLEMENTED / RE-ACCEPTANCE PENDING, 2026-08-26`:** Manifestin exact sekiz PNG/ICO asset'i artık source-controlled `eng/New-WindowsProductionAssets.ps1` tarifiyle dış source asset, üçüncü taraf girdi, font, metin veya marka girdisi olmadan byte-identical üretilir. Strict provenance ledger'ı exact path/dimension veya ICO frame seti/length/hash bağlarını ve canonical asset setini fail-closed doğrular. Üretilen görseller yalnız geliştirme amaçlı nötr teknik placeholder'dır; public marka/logo onayı, copyright ownership, redistribution kararı, root `LICENSE`/`NOTICE`, Store/legal veya codec-IP kapanışı değildir. Asset byte değişimi package-producing snapshot'ı değiştirdiğinden yukarıdaki SBOM/CVE run ve ledger'ları tarihsel kabul olarak kalır; yeni hosted package SBOM ve ona zincirli CVE acceptance yenilenmeden final 12-blocker/readiness sonucu iddia edilmez.
