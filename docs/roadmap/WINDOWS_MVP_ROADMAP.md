...
**Implementation/acceptance status — `PARTIAL VERIFIED, 2026-08-25`:** Commit `8d537010f64193f7bc9baf05bc3707fb31d5362f` için [run `32764149667`](https://github.com/serkankaracan/iptv-suite/actions/runs/32764149667) signed production package'ta 25 rapid switch ile fullscreen/focus/resize/minimize/state/active-close zincirini geçti. Commit `b10b6ceb56eaba51668169dca904524808f4517b` için [run `32783701519`](https://github.com/serkankaracan/iptv-suite/actions/runs/32783701519) protected source-delete UI checkpoint'inin required gate'ini yeşil tuttu; product delete E2E değildir. [Run `32785306860`](https://github.com/serkankaracan/iptv-suite/actions/runs/32785306860)/commit `33afcef741f518b439c9934b0f4035fd92662586` packaged kısa-run resource guard'ını `PlaybackResourceBudgetVerified=true` ile geçti: private `-860.160 byte`, working set `+4.169.728 byte`, handle `-30`, thread `-7`, p95 `2229,342 ms`. Bu ayrı guard M10/M16 uzun-soak kabulünü değiştirmez. Fiziksel DPI/mixed-DPI multi-monitor, gerçek sleep/wake, audio endpoint, Narrator ve product source-delete E2E `NOT RUN` kaldığından milestone tamamlanmış sayılmaz. [Kısmi kabul kanıtı](../quality/M12_COMPLETION_EVIDENCE.md).
