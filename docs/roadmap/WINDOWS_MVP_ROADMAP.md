...
- Production graph/MSIX dışında framework-dependent x64 harness ile gerçek farklı-SID raw DPAPI ve production-adapter boundary lane'i; hosted execution acceptance'ı ayrı kalır.
