...
- `IptvSuite.PlaybackCompatibilitySpike`: yalnız M10 compatibility/license/MSIX hard gate'i için kullanılan disposable, nonpackable/nonpublishable x64 WinUI test paketidir. Production projeleri tarafından referans alınamaz, production MSIX'e giremez ve sentetik/hakları temiz corpus dışındaki locator veya gerçek provider/account kullanamaz. Normal quality gate projeyi derleyebilir fakat spike/soak executable'ını çalıştırmaz.
