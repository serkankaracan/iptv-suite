...
Bu klasör Windows uygulamasını, M2 test scaffold'unu, M3 saf domain/validation çekirdeğini ve M4'ün protected-storage dilimini içerir. M2 hosted kabulü ve M3 local mühendislik kabulü **PASS, 2026-08-09** durumundadır. M4 foundation `IN PROGRESS`; 2026-08-13 hosted run `31735655363`, source-draft protection, packaged composition ve startup temp-aday cap'i dahil 153/153 testi iki deterministik koşuda; signed packaged-smoke ve required coordinator'ı başarıyla tamamlamıştır. Sonraki internal decoder dilimiyle local exact-SDK gate 159/159 testi iki deterministik koşuda geçmiştir; decoder için hosted kanıt henüz yoktur. Uygulama UI'sı hâlâ yalnız gerçek assembly/package sürümünü, build configuration'ını ve process architecture'ını gösteren development shell'dir; source formu, network/provider, parser, database veya playback özelliği henüz yoktur.
