...
| Packaged lifecycle | Ayrı test MSIX'inde iki process arasında CurrentUser DPAPI v2 create/read/wrong-owner/update/delete/post-delete ve exact cleanup | Production PFN, package version update/reset/reinstall, second-user veya source-wide reconciliation |
