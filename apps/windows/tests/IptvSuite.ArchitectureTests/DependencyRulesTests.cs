...
public sealed class DependencyRulesTests
{
    ...
    public void M9CatalogUiKeepsQueriesBoundedVirtualizedAndAccessible()
    {
        ...
        StringAssert.Contains(codeBehind, "UIElement.GettingFocusEvent");
        StringAssert.Contains(codeBehind, "new TypedEventHandler<UIElement, GettingFocusEventArgs>(CatalogFilter_GettingFocus)");
